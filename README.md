<!-- Profile Header -->
<div align="center">
  <img src="https://readme-typing-svg.demolab.com?font=Fira+Code&weight=500&size=24&pause=1000&color=F97316&center=true&vCenter=true&width=435&lines=Hi+there+%F0%9F%91%8B+I'm+Gopalkrishnan;Aspiring+Web+Developer;Building+Practical+Frontend+Projects!" alt="Typing SVG" />
</div>
...
<h3 align="center">🚀 Growing with every line of code I write.</h3>
...
|----------------------------------|--------------------------------------------------|-------------------------------------|-----------|
| **Bus Finder (AI Prediction)**   | Predict TN bus timings using ARIMA (no GPS)      | Java, Firebase, RoomDB              | [Code](https://github.com/Gopal-6382/Bus-Apk) |
| **React Components**             | Multiple components – cart, password gen, etc.   | React, Axios, Context, Reducers     | [Live](https://react-components-ayicj5gdi-gopal-krishnan.vercel.app) |
...
📌 Java CLI utilities and OOP
📌 Exploring Tailwind CSS design systems
